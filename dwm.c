...
enum { SchemeNorm, SchemeSel, SchemeStatus, SchemeTagsSel, SchemeTagsNorm, SchemeInfoSel, SchemeInfoNorm, SchemeCol1, SchemeCol2, SchemeCol3,
...
setup(void)
{
	...
	lrpad = tag_padding ? tag_padding : drw->fonts->h;
